...
function NewsletterForm() {
  return (
    <div className='h-133.5 min-w-full mt-47.75 flex items-center justify-center bg-primary'>
      <div className='w-308 flex flex-col items-center '>
        ...
        <div className='text-center w-138.75 mt-6 leading-6'>
